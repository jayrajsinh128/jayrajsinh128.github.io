          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/jayrajsinh128/SnapDeal" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /></a>
                <a href="https://produvtpage.vercel.app/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a> </div>
            </header>
            <div className="body">
              <h3>Snapdeal Clone</h3>
              <p>Developed a Snapdeal clone using HTML, CSS, and JavaScript, featuring a visually appealing and responsive user interface. The application replicates core functionalities, including product display, navigation, and basic interactions, to provide an engaging e-commerce experience.</p>
            </div>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/jayrajsinh128/react/tree/main/project" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
                <a href="https://my-store-sooty-theta.vercel.app/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" /></a>
              </div>
            </header>
            <div className="body">
              <h3>Mini Store: A React-Based E-commerce Application
              </h3>
              <p>
              Developed a dynamic e-commerce platform named Mini Store using React. This application provides users with a seamless shopping experience, featuring an intuitive user interface and efficient functionality for browsing and purchasing products. Hosted on Vercel, the project is designed to be fast, responsive, and user-friendly.              </p>
            </div>
            <footer>
